...
public class SimpleDatabaseUtil {
     ...
     * @return - return column name {@link sqlitesimple.library.annotations.Column}, or field name if null
     */
     ...
     * @return - return table name {@link sqlitesimple.library.annotations.Table}, or class name if null
     */
    ...
    /**
     * @param field            - Java field
     * @param columnAnnotation - {@link sqlitesimple.library.annotations.Column}
